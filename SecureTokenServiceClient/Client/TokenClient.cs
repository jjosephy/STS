...
namespace SecureTokenServiceClient.Client
{
    public class TokenClient
    {
        ...
        readonly Uri baseUri = new Uri("http://JOSEPHYJASODFA5:8088");
        ...
        public async Task<TokenResponseModel> GetTokenAsync(AuthenticationModel authentication)
        {
            try
            {
                HttpWebRequest Request = (HttpWebRequest)WebRequest.Create("http://JOSEPHYJASODFA5:8088/token");
        ...
        private X509Certificate GetClientCert()
        {
            ...
            try
            {
                ...
                var certs = store.Certificates.Find(X509FindType.FindBySubjectName, "*.api.dev.nordstrom.com", true);
